            ...
            <div className="w-full max-w-md bg-surface/60 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-2xl shadow-2xl shadow-slate-200/50 dark:shadow-black/50 overflow-hidden flex flex-col relative z-10 transition-colors duration-300">
                ...
                <div className="flex flex-col items-center pt-10 pb-6 px-8">
                    <div className="relative mb-6 group">
                        ...
                        <div className="relative h-20 w-20 bg-surface rounded-full flex items-center justify-center border border-slate-200 dark:border-white/10 shadow-lg group-hover:scale-105 transition-transform duration-300">
                            <span className="material-symbols-outlined text-transparent bg-clip-text bg-gradient-to-br from-cyan-400 to-blue-500 text-5xl">person_add</span>
                        </div>
                    </div>
                ...
                <div className="flex flex-col px-8 py-6 gap-5">
                    ...
                    <label className="flex flex-col gap-2 group">
                        <span className="text-text-secondary text-sm font-medium tracking-wide ml-1 group-focus-within:text-primary transition-colors">{t.fullName}</span>
                        <input
                    ...
                    {/* Phone Number Input */}
                    <label className="flex flex-col gap-2 group">
                        <span className="text-text-secondary text-sm font-medium tracking-wide ml-1 group-focus-within:text-primary transition-colors">{t.phoneNumber}</span>
                        <input
                            className="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-surface/50 text-text-main h-14 pl-4 pr-4 text-lg placeholder:text-text-secondary/50 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none shadow-inner"
                    ...
                    {/* Password Input */}
                    <label className="flex flex-col gap-2 group">
                        <span className="text-text-secondary text-sm font-medium tracking-wide ml-1 group-focus-within:text-primary transition-colors">{t.createPassword}</span>
                        <div className="relative flex w-full items-center">
                            ...
                            />
                            <button
                                className="absolute right-0 top-0 h-full px-4 text-text-secondary hover:text-primary transition-colors flex items-center justify-center"
                                type="button"
                    ...
                    <label className="flex flex-col gap-2 group">
                        <span className="text-text-secondary text-sm font-medium tracking-wide ml-1 group-focus-within:text-primary transition-colors">{t.confirmPassword}</span>
                        <div className="relative flex w-full items-center">
                            <input
                                className="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-surface/50 text-text-main h-14 pl-4 pr-12 text-lg placeholder:text-text-secondary/50 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none shadow-inner"
                    ...
                    {/* Terms */}
                    <p className="text-center text-text-secondary/60 text-xs leading-relaxed px-2">
                        {t.agreeToTerms}
                    </p>

                    {/* Sign In Link */}
                    <p className="text-center text-text-secondary text-sm mt-1 pb-4">
                        {t.alreadyHaveAccount}{' '}
                        <Link className="text-primary font-semibold hover:text-primary-dark hover:underline transition-colors" href="/login">
                            {t.signIn}
                        </Link>
                    </p>
                </div>
