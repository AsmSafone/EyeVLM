...
export const translations = {
  en: {
    ...
    welcomeBackUser: "Welcome back, Admin",
  ...
  bn: {
    ...
    welcomeBackUser: "স্বাগতম, অ্যাডমিন",
    ...
    cropImage: "ছবি ক্রপ করুন",
    dragToAdjust: "সামঞ্জস্য করতে টানুন",
    aspectRatio: "আকৃতি অনুপাত",
    free: "মুক্ত",
    square: "বর্গাকার",
    ...
    security: "নিরাপত্তা",
    language: "ভাষা",
    appearance: "ডার্ক মোড",
    helpSupport: "সাহায্য ও সহায়তা",
    consultDoctor: "ডাক্তার দেখান",
