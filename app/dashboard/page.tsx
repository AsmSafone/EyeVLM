...
export default function Dashboard() {
  ...
  return (
    <div className="bg-background font-sans min-h-screen flex justify-center antialiased relative overflow-hidden transition-colors duration-300">
      ...
      <div className="relative flex flex-col w-full max-w-md min-h-screen pb-24 z-10">
