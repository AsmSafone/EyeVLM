                ...
                <div className="flex-1 px-6 py-8 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="tel" placeholder="+8801XXX-XXXXXX" className="w-full rounded-2xl border border-slate-200 dark:border-white/10 bg-surface/50 px-4 py-4 text-text-main placeholder:text-text-secondary/50 focus:ring-1 focus:ring-primary focus:border-primary/50 transition-all font-medium" />
                        </div>
                    </div>
