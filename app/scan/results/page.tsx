...
export default function Results() {
  ...
  return (
    <div className="bg-background font-sans antialiased text-text-main min-h-screen flex justify-center relative overflow-hidden transition-colors duration-300">
      ...
      <div className="relative flex flex-col w-full max-w-md h-screen overflow-hidden z-10">


        {/* Top App Bar */}
        <div className="sticky top-0 z-50 bg-surface/80 backdrop-blur-xl border-b border-slate-200 dark:border-white/5 transition-colors duration-300 shrink-0">
        ...
        {/* Main Content */}
        <main className="flex-1 flex flex-col gap-6 p-4 pb-24 overflow-y-auto w-full relative z-10">
