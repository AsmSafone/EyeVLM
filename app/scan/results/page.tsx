    ...
    <div className="bg-background font-sans antialiased text-text-main min-h-screen flex flex-col relative overflow-hidden transition-colors duration-300">
      ...
      <main className="flex-1 flex flex-col gap-6 p-4 pb-24 overflow-y-auto w-full max-w-md mx-auto relative z-10">
        ...
        <div className="flex flex-col gap-4 mt-2">
          <button className="w-full bg-primary hover:bg-primary-dark text-white font-bold py-4 rounded-2xl shadow-[0_0_20px_rgba(6,182,212,0.25)] flex items-center justify-center gap-2 transition-all active:scale-[0.98] border border-primary/20 hover:shadow-[0_0_30px_rgba(6,182,212,0.4)]">
            <span className="material-symbols-outlined">description</span>
            {t.downloadReport}
          </button>
          <button className="w-full bg-surface/50 border border-slate-200 dark:border-white/10 text-primary hover:bg-surface-highlight hover:text-text-main hover:border-slate-300 dark:hover:border-white/20 font-bold py-4 rounded-2xl flex items-center justify-center gap-2 transition-all active:scale-[0.98] backdrop-blur-sm">
